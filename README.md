...
<!-- Last Updated: 2025-07-29 19:35:07 UTC -->
...
| [GithubRepoActivity](https://github.com/jorgeasaurus/GithubRepoActivity) | 66 |
...
| [WinGet-Manifest-Fetcher](https://github.com/jorgeasaurus/WinGet-Manifest-Fetcher) | 2 days ago | ![](https://img.shields.io/badge/-PowerShell-012456?style=flat-square&logoColor=white) | ⭐ 3 |
...
- **Process Automation** - Streamlining IT operations through intelligent automation
- **Technical Debt Reduction** - Modernizing legacy systems and processes
- **Security Enhancement** - Implementing zero-trust security frameworks
- **Configuration as Code** - Infrastructure and policy management through version control
- **CI/CD Pipelines** - Advanced GitHub Actions and deployment strategies

## 📝 Latest Blog Posts

<!-- BLOG-POST-LIST:START -->
[WinGet Without WinGet: Building a Cross-Platform Package Manifest Fetcher](https://www.jorgeasaur.us/winget-without-winget-building-a-cross-platform-package-manifest-fetcher/)
...
_"Automating the world, one script at a time."_ 🚀

<div align="center">
  <img src="./meCropped.jpeg" alt="Jorge" style="margin-top: 20px;">
</div>
